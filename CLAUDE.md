...
- Selectivity value criterion (2026-08-05, Pan Yao inquiry Q1, binding): before claiming selectivity against structural analogues, a scheme must evidence (a) their detection frequency/concentration in the target water and (b) their risk (PNEC/toxicity/regulation) relative to the target. High-frequency and lower-risk analogues are worth excluding selectively; absent analogues make the claim void; equal-or-higher-risk analogues must be co-removed as a class. Selectivity against DOM/salt matrix background is the baseline requirement. Equimolar analogue cocktails are mechanism probes only; environmental-value claims need environmentally proportioned mixtures. Full text: `docs/SELECTIVITY_VALUE_CRITERION_2026-08-05.md`; framework anchor: `docs/BIOMIMETIC_DESIGN_FRAMEWORK.md` §10 (main-style framework synced 2026-08-05 by fresh_1000_R4); SPEC anchor: `rounds/fresh_1000/SPEC.md` closure criterion 10; GLOBAL_SPEC anchor: `rounds/fresh_1000/GLOBAL_SPEC.md` G9.1.
...
2026-08-05: Pan Yao inquiry Q1 on the value of selectivity (detection frequency + PNEC risk of analogue competitors) adopted as a binding project-wide criterion. Added `docs/SELECTIVITY_VALUE_CRITERION_2026-08-05.md` (norm + branch audit + per-scheme actions), framework §十二, SPEC closure criterion 10, GLOBAL_SPEC G9.1, and appended audit addenda (append-only) to the nine scheme files on this branch: S05 (largely compliant), S14 (non-compliant, rectify with main BPA20-01), S17/S26 (compliant positive examples), S27/S32/S34 (partially non-compliant), S31 (non-compliant, occurrence/risk evidence missing), S51 (non-compliant, directional error, archived as D-tier stopped). Note: this commit temporarily supersedes the 2026-07-24 "Qwen receives no new commits" note for the cross-branch alignment round of the same date, executed at Pan Yao's direct instruction covering main/Qwen/Ultimate/dsreview.
