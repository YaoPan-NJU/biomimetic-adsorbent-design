...
> **2026-07-19课题范围追加裁决：本报告中的PFH-1以强/弱碱离子交换位点为主要捕获基础，属于离子交换树脂方向。潘尧明确要求主材料必须是仿生吸附材料而非离子交换树脂，因此PFH-1已经终止，M0不再执行。本报告保留为设计与否决审计，不能作为当前实验方案。现行边界见`docs/MATERIAL_SCOPE_BOUNDARY_ION_EXCHANGE.md`和Gate G29。**
