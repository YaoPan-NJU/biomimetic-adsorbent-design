...
3. Read the complete `rounds/bpa1_deep_design_1/` sequence through `P1_MAPY_ATTACK.md`, then both files under `rounds/bpa2_deep_design_1/`; retain P1 only as an experiment-gated probe, BPA-2E as a positive engineering control, BPA-2R as unfrozen, and begin PFBS-1 paper attack.
