...
3. Read the complete `rounds/bpa1_deep_design_1/` sequence through `P1_MAPY_ATTACK.md`, then `rounds/bpa2_deep_design_1/BPA2_BASELINE_AND_COLOCALIZATION_ATTACK.md`; retain P1 only as an experiment-gated probe, keep BPA-2R unfrozen, and compare lightweight high-accessible-beta-CD architectures only for BPA-2E.
