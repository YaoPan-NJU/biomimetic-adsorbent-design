...
3. Read the complete `rounds/bpa1_deep_design_1/` sequence through `P1_MAPY_ATTACK.md`; retain P1 only as an experiment-gated probe and begin BPA-2 paper deepening without restoring R1 or the symmetric-clamp requirement.
