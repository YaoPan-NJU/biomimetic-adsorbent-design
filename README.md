...
当前阶段是对分支导入的100套假设进行主分支重新分类。必须先区分功能仿生、生物机制参考和理性化学设计，再对通过环境门且具有至少一项可落地硬对应的少数方案重新评分。PFOA-FABP4、BPA-3、DCP-101及ROX肟醚路线均不继承分支高分；DCP-1在重新分类期间暂停于原环境和水相机制门。
...
7. [`portfolio_100/SUPERVISOR_AUDIT.md`](rounds/portfolio_100/SUPERVISOR_AUDIT.md)
