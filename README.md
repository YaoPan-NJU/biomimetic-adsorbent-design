...
当前活动候选是 **S1-SYN**：hL-FABP 启发的非蛋白人工 PFOA/长链 PFCA 选择性吸附材料。第一代材料边界为 OEG 钝化介孔硅与一个尚待冻结的非肽胍基/酰胺—有限低极性链段受体。目标是在真实二级出水中获得可解释的竞争选择性，不追求以纯水最大容量作为中心结论。

当前唯一下一动作是按 [`S1_SYNTHETIC_RECOVERY_BRIEF.md`](rounds/synthetic_recovery_1/S1_SYNTHETIC_RECOVERY_BRIEF.md) 提交一个确切非肽受体、匹配对照和 OEG 介孔硅固定化 SOP。在该设计通过前，不订购、不合成、不开展实验，也不继续 S11 Gate 1b/Gate 2。
