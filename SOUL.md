...
- Biomimicry and ion exchange are independent scientific classification axes. Electrostatic attraction is not synonymous with ion exchange; ion exchange requires target-ion uptake with equivalent displacement of other ions. A material may scientifically be both biomimetic and ion-exchanging, and both labels must then be disclosed. For this project's scope, the main material cannot be primarily classified or published as a conventional or mixed-mode ion-exchange resin. Fixed charge and a minor exchange contribution may assist a separately supported biomimetic function, but IEC, Donnan behavior, counter-ion balance and matched-charge controls must quantify the contribution and prove independent biomimetic causality. Read `docs/SCIENTIFIC_CONSENSUS_BIOMIMETIC_AND_ION_EXCHANGE.md` before applying `docs/MATERIAL_SCOPE_BOUNDARY_ION_EXCHANGE.md`.
