...
| 编号 | 日期 | 提出人 | 问题 | 处置 |
|---|---|---|---|---|
| Q1 | 2026-08-05 | 潘尧 | 选择性价值判据：对结构同系物的选择性须先证明其环境检出频率与风险（PNEC）格局，否则属虚空索敌；风险同级应共捕；真正有用的选择性是对 DOM/盐等基质背景 | 已共识化为 `docs/SELECTIVITY_VALUE_CRITERION_2026-08-05.md`；全分支审计完成；main 三条深度设计文件已追加整改附录；Qwen/Ultimate 方案文件整改方式待确认 |
