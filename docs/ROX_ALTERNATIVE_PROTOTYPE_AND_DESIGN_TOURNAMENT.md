...
> 后续G22已改变两项边界：大环内酯类共同去除可以通过目标门，膜分离不进入当前产品范围。因此本文件的G21排序保留为历史裁决，现行方向以 [`ROX_MACROLIDE_CLASS_LOW_COST_ADSORBENT_REPLAN.md`](ROX_MACROLIDE_CLASS_LOW_COST_ADSORBENT_REPLAN.md) 为准。
